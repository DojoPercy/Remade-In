import {
  require_dist
} from "./chunk-JCJSTCBV.js";
import {
  require_react_dom
} from "./chunk-NJ3K7FFS.js";
import {
  CheckmarkIcon,
  ChevronDownIcon,
  ChevronRightIcon,
...
} from "./chunk-HIKIMYKJ.js";
import {
  require_jsx_runtime
} from "./chunk-T5FNUVPL.js";
import {
  require_react
} from "./chunk-K2G3QNYO.js";
import {
  __commonJS,
  __esm,
  __export,
...
// ../node_modules/.pnpm/@sanity+ui@2.16.22_@emotion_23d1b0aa918918bf188b4335a184b3a2/node_modules/@sanity/ui/dist/theme.mjs
...
function hslToRgb(hsl) {
  const s = hsl.s / 100, l2 = hsl.l / 100, c4 = (1 - Math.abs(2 * l2 - 1)) * s, x2 = c4 * (1 - Math.abs(hsl.h / 60 % 2 - 1)), m3 = l2 - c4 / 2;
  let r2 = 0, g2 = 0, b2 = 0;
...
function __read(o2, n) {
  ...
  try {
    ...
    try {
      if (r2 && !r2.done && (m3 = i["return"])) m3.call(i);
    } finally {
      if (e) throw e.error;
    }
  }
...
function __asyncValues(o2) {
  ...
  return m3 ? m3.call(o2) : (o2 = typeof __values === "function" ? __values(o2) : o2[Symbol.iterator](), i = {}, verb("next"), verb("throw"), verb("return"), i[Symbol.asyncIterator] = function() {
    return this;
  }, i);
  function verb(n) {
...
// ../node_modules/.pnpm/styled-components@6.3.11_re_e3e514eb548d0314d3a198ffaaa0f2dd/node_modules/styled-components/dist/styled-components.browser.esm.js
...
function ruleset(value, root, parent, index2, offset4, rules, points, type, props, children, length2, siblings) {
  ...
  for (var i = 0, j2 = 0, k2 = 0; i < index2; ++i)
    for (var x2 = 0, y2 = substr(value, post + 1, post = abs(j2 = points[i])), z2 = value; x2 < size5; ++x2)
...
function oe(e, t, n) {
  if ("string" != typeof t) {
    ...
    for (var s = X(e), i = X(t), a2 = 0; a2 < r2.length; ++a2) {
      var c4 = r2[a2];
      if (!(c4 in H || n && n[c4] || i && c4 in i || s && c4 in s)) {
        var u2 = ee(t, c4);
        try {
          Z(e, c4, u2);
        } catch (e2) {
...
var pe = function() {
  ...
  return e.prototype.indexOfGroup = function(e2) {
    ...
    for (var i = this.indexOfGroup(e2 + 1), a2 = 0, c4 = (s = 0, t.length); s < c4; s++) this.tag.insertRule(i, t[s]) && (this.groupSizes[e2]++, i++, a2++);
...
var ve = function(e, t) {
  for (var n, o2 = (null !== (n = t.textContent) && void 0 !== n ? n : "").split(p), r2 = [], s = 0, i = o2.length; s < i; s++) {
    ...
    if (a2) {
      var c4 = a2.match(de);
      if (c4) {
        var u2 = 0 | parseInt(c4[1], 10), l2 = c4[2];
        0 !== u2 && (E(l2, u2), ye(e, l2, c4[3]), e.getTag().insertRules(u2, r2)), r2.length = 0;
      } else r2.push(a2);
    }
  }
};
    ...
    this.options = __assign(__assign({}, Ae), e2), this.gs = n, this.names = new Map(o2), this.server = !!e2.isServer, !this.server && h && Ce && (Ce = false, ge(this)), le(this, function() {
      return function(e3) {
        for (var t = e3.getTag(), n2 = t.length, o3 = "", r3 = function(n3) {
          ...
          var c4 = a + ".g" + n3 + '[id="' + r4 + '"]', u2 = "";
          s2.forEach(function(e4) {
            e4.length > 0 && (u2 += e4 + ",");
          }), o3 += i + c4 + '{content:"' + u2 + '"}' + p;
        }, s = 0; s < n2; s++) r3(s);
        return o3;
      }(r2);
    });
...
function Te(e) {
  var t, n, o2, r2 = void 0 === e ? I : e, i = r2.options, a2 = void 0 === i ? I : i, c4 = r2.plugins, u2 = void 0 === c4 ? P : c4, l2 = function(e2, o3, r3) {
  ...
  var h2 = [], d2 = middleware(p2.concat(rulesheet(function(e2) {
    return h2.push(e2);
  }))), f2 = function(e2, r3, i2, c5) {
    void 0 === r3 && (r3 = ""), void 0 === i2 && (i2 = ""), void 0 === c5 && (c5 = "&"), t = c5, n = r3, o2 = void 0;
    var u3 = function(e3) {
      if (!De(e3)) return e3;
      for (var t2 = e3.length, n2 = "", o3 = 0, r4 = 0, s = 0, i3 = false, a3 = 0; a3 < t2; a3++) {
        var c6 = e3.charCodeAt(a3);
        if (0 !== s || i3 || c6 !== Ie || e3.charCodeAt(a3 + 1) !== Oe) if (i3) c6 === Oe && e3.charCodeAt(a3 + 1) === Ie && (i3 = false, a3++);
        else if (34 !== c6 && 39 !== c6 || 0 !== a3 && 92 === e3.charCodeAt(a3 - 1)) {
          if (0 === s) if (123 === c6) r4++;
          else if (125 === c6) {
            if (--r4 < 0) {
          ...
          } else 59 === c6 && 0 === r4 && (n2 += e3.substring(o3, a3 + 1), o3 = a3 + 1);
        } else 0 === s ? s = c6 : s === c6 && (s = 0);
        else i3 = true, a3++;
      }
      if (o3 < t2) {
...
function qe(e, t, n, o2, r2) {
  ...
  if (ce(e)) {
    for (var a2 = We(e), c4 = 0; c4 < a2.length; c4++) r2.push(a2[c4]);
    return r2;
  }
  if (!Array.isArray(e)) return r2.push(e.toString()), r2;
  for (c4 = 0; c4 < e.length; c4++) qe(e[c4], t, n, o2, r2);
  return r2;
}
function He(e) {
...
var Je = function() {
  ...
  return e.prototype.generateAndInjectStyles = function(e2, t, n) {
    ...
    if (this.isStatic && !n.hash) if (this.staticRulesId && t.hasNameForId(this.componentId, this.staticRulesId)) o2 = ie(o2, this.staticRulesId);
      ...
      for (var a2 = F(this.baseHash, n.hash), c4 = "", u2 = 0; u2 < this.rules.length; u2++) {
        var l2 = this.rules[u2];
        if ("string" == typeof l2) c4 += l2, a2 = F(a2, l2);
        else if (l2) {
          var p2 = ae(qe(l2, e2, t, n));
          a2 = F(F(a2, String(u2)), p2), c4 += p2;
        }
      }
      if (c4) {
        var h2 = M(a2 >>> 0);
        if (!t.hasNameForId(this.componentId, h2)) {
          var d2 = n(c4, ".".concat(h2), void 0, this.componentId);
...
function nt(e, s, i) {
  var a2 = se(e), c4 = e, u2 = !z(e), p2 = s.attrs, h2 = void 0 === p2 ? P : p2, d2 = s.componentId, f2 = void 0 === d2 ? function(e2, t) {
    var n = "string" != typeof e2 ? "sc" : x(e2);
    et[n] = (et[n] || 0) + 1;
    var o2 = "".concat(n, "-").concat(L(l + n + et[n]));
    return t ? "".concat(t, "-").concat(o2) : o2;
  }(s.displayName, s.parentComponentId) : d2, m3 = s.displayName, y2 = void 0 === m3 ? function(e2) {
    return z(e2) ? "styled.".concat(e2) : "Styled(".concat(B(e2), ")");
  }(e) : m3, v2 = s.displayName && s.componentId ? "".concat(x(s.displayName), "-").concat(s.componentId) : s.componentId || f2, g2 = a2 && c4.attrs ? c4.attrs.concat(h2).filter(Boolean) : h2, S2 = s.shouldForwardProp;
  if (a2 && c4.shouldForwardProp) {
    var w2 = c4.shouldForwardProp;
  ...
  var N2 = new Je(i, v2, a2 ? c4.componentStyle : void 0);
  function E2(e2, s2) {
    return function(e3, s3, i2) {
      var a3 = e3.attrs, c5 = e3.componentStyle, u3 = e3.defaultProps, l2 = e3.foldedComponentIds, p3 = e3.styledComponentId, h3 = e3.target, d3 = import_react.default.useContext(Xe), f3 = Fe(), m4 = e3.shouldForwardProp || f3.shouldForwardProp;
      ...
      for (var w3 in v3) void 0 === v3[w3] || "$" === w3[0] || "as" === w3 || "theme" === w3 && v3.theme === y3 || ("forwardedAs" === w3 ? S3.as = v3.forwardedAs : m4 && !m4(w3, g3) || (S3[w3] = v3[w3], m4 || false || isPropValid(w3) || tt.has(w3) || !D.has(g3) || (tt.add(w3), console.warn('styled-components: it looks like an unknown prop "'.concat(w3, '" is being sent through to the DOM, which will likely trigger a React console error. If you would like automatic filtering of unknown props, you can opt-into that behavior via `<StyleSheetManager shouldForwardProp={...}>` (connect an API like `@emotion/is-prop-valid`) or consider using transient props (`$` prefix for automatic filtering.)')))));
  ...
  return C2.attrs = g2, C2.componentStyle = N2, C2.displayName = y2, C2.shouldForwardProp = S2, C2.foldedComponentIds = a2 ? ie(c4.foldedComponentIds, c4.styledComponentId) : "", C2.styledComponentId = v2, C2.target = a2 ? c4.target : e, Object.defineProperty(C2, "defaultProps", { get: function() {
...
function lt(n) {
  ...
  var i = st.apply(void 0, __spreadArray([n], r2, false)), a2 = "sc-global-".concat(L(JSON.stringify(i))), c4 = new ut(i, a2);
  _(a2);
  var u2 = /* @__PURE__ */ new WeakMap(), l2 = function(e) {
    ...
    return void 0 === r3 && (r3 = t.styleSheet.allocateGSInstance(a2), u2.set(t.styleSheet, r3)), import_react.default.Children.count(e.children) && console.warn("The global style component ".concat(a2, " was given child JSX. createGlobalStyle does not render children.")), i.some(function(e2) {
      ...
      return t.styleSheet.server || p2(r3, e, t.styleSheet, n2, t.stylis), function() {
        var e2;
        c4.removeStyles(r3, t.styleSheet), e2 = t.styleSheet.options.target, "undefined" != typeof document && (null != e2 ? e2 : document).querySelectorAll('style[data-styled-global="'.concat(a2, '"]')).forEach(function(e3) {
          return e3.remove();
        });
      };
  ...
  function p2(e, n2, o2, r3, s2) {
    if (c4.isStatic) c4.renderStyles(e, f, o2, s2);
    else {
      var i2 = __assign(__assign({}, n2), { theme: O(n2, r3, l2.defaultProps) });
      c4.renderStyles(e, i2, o2, s2);
    }
  }
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/components/AnimatePresence/index.mjs
var import_jsx_runtime3 = __toESM(require_jsx_runtime(), 1);
var import_react11 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/context/LayoutGroupContext.mjs
var import_react2 = __toESM(require_react(), 1);
var LayoutGroupContext = (0, import_react2.createContext)({});

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/utils/use-constant.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/utils/use-isomorphic-effect.mjs
var import_react4 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/utils/is-browser.mjs
var isBrowser = typeof window !== "undefined";

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/utils/use-isomorphic-effect.mjs
var useIsomorphicLayoutEffect = isBrowser ? import_react4.useLayoutEffect : import_react4.useEffect;

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/components/AnimatePresence/PresenceChild.mjs
var import_jsx_runtime2 = __toESM(require_jsx_runtime(), 1);
var React3 = __toESM(require_react(), 1);
var import_react8 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/context/PresenceContext.mjs
var import_react5 = __toESM(require_react(), 1);
var PresenceContext = (0, import_react5.createContext)(null);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/components/AnimatePresence/PopChild.mjs
...
function createRenderBatcher(scheduleNextBatch, allowKeepAlive) {
  ...
  const cancel = (process3) => {
    for (let i = 0; i < stepsOrder.length; i++) {
      steps2[stepsOrder[i]].cancel(process3);
    }
  };
...
var cubicBezierAsString = ([a2, b2, c4, d2]) => `cubic-bezier(${a2}, ${b2}, ${c4}, ${d2})`;
...
var AsyncMotionValueAnimation = class extends WithPromise {
  ...
  onKeyframesResolved(keyframes2, finalKeyframe, options, sync2) {
    ...
    const animation2 = useWaapi ? new NativeAnimationExtended({
      ...resolvedOptions,
      element
...
function getValueTransition(transition, key2) {
  const valueTransition = (transition == null ? void 0 : transition[key2]) ?? (transition == null ? void 0 : transition["default"]) ?? transition;
...
function addSVGPathValue(element, state, key2, value) {
  ...
  if (key2 === "pathOffset") {
    return state.set(key2, value, () => {
      const offset4 = state.latest[key2];
      element.setAttribute("stroke-dashoffset", `${-offset4}`);
    });
  } else {
...
var VisualElement = class {
  ...
  mount(instance) {
    ...
    if (this.hasBeenMounted) {
      for (const key2 in this.initialValues) {
        (_a = this.values.get(key2)) == null ? void 0 : _a.jump(this.initialValues[key2]);
  ...
  bindToMotionValue(key2, value) {
    ...
    if (value.accelerate && acceleratedValues2.has(key2) && this.current instanceof HTMLElement) {
      ...
      const cleanup = factory(animation2);
...
function scrapeMotionValuesFromProps(props, prevProps, visualElement) {
  ...
  for (const key2 in style) {
    if (isMotionValue(style[key2]) || prevStyle && isMotionValue(prevStyle[key2]) || isForcedMotionValue(key2, props) || ((_a = visualElement == null ? void 0 : visualElement.getValue(key2)) == null ? void 0 : _a.liveStyle) !== void 0) {
  ...
  promote(node2, preserveFollowOpacity) {
    ...
    if (prevLead) {
      ...
      if (prevDep === void 0 || prevDep !== nextDep) {
        ...
        if ((_a = node2.root) == null ? void 0 : _a.isUpdating)
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/context/MotionConfigContext.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/utils/use-composed-ref.mjs
...
function PopChild({ children, isPresent, anchorX, anchorY, root, pop }) {
  ...
  (0, import_react7.useInsertionEffect)(() => {
    const { width, height, top, left, right, bottom } = size5.current;
  ...
  return (0, import_jsx_runtime.jsx)(PopChildMeasure, { isPresent, childRef: ref, sizeRef: size5, pop, children: pop === false ? children : React2.cloneElement(children, { ref: composedRef }) });
}
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/components/AnimatePresence/use-presence.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/components/AnimatePresence/utils.mjs
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, presenceAffectsLayout = true, mode = "sync", propagate = false, anchorX = "left", anchorY = "top", root }) => {
  ...
  return (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: renderedChildren.map((child) => {
    ...
    return (0, import_jsx_runtime3.jsx)(PresenceChild, { isPresent, initial: !isInitialRender.current || initial ? void 0 : false, custom, presenceAffectsLayout, mode, root, onExitComplete: isPresent ? void 0 : onExit, anchorX, anchorY, children: child }, key2);
  }) });
};

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/render/dom/create-visual-element.mjs
var import_react12 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/render/svg/lowercase-elements.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/render/dom/utils/is-svg-component.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/motion/index.mjs
var import_jsx_runtime4 = __toESM(require_jsx_runtime(), 1);
var import_react23 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/context/LazyContext.mjs
var import_react13 = __toESM(require_react(), 1);
var LazyContext = (0, import_react13.createContext)({ strict: false });

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/context/MotionContext/index.mjs
var import_react14 = __toESM(require_react(), 1);
var MotionContext = (0, import_react14.createContext)({});

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/context/MotionContext/create.mjs
var import_react15 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/context/MotionContext/utils.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/render/dom/use-render.mjs
var import_react18 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/render/html/use-props.mjs
var import_react16 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/render/html/utils/create-render-state.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/render/svg/use-props.mjs
var import_react17 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/render/svg/utils/create-render-state.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/motion/utils/valid-prop.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/render/dom/utils/filter-props.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/motion/utils/use-visual-state.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/render/html/use-html-visual-state.mjs
var useHTMLVisualState = makeUseVisualState({
  scrapeMotionValuesFromProps,
  createRenderState: createHtmlRenderState
});

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/render/svg/use-svg-visual-state.mjs
var useSVGVisualState = makeUseVisualState({
  scrapeMotionValuesFromProps: scrapeMotionValuesFromProps2,
  createRenderState: createSvgRenderState
});

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/motion/features/definitions.mjs
var featureProps = {
  animation: [
    "animate",
    "variants",
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/motion/features/load-features.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/motion/utils/symbol.mjs
var motionComponentSymbol = Symbol.for("motionComponentSymbol");

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/motion/utils/use-motion-ref.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/motion/utils/use-visual-element.mjs
var import_react22 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/context/SwitchLayoutGroupContext.mjs
var import_react21 = __toESM(require_react(), 1);
var SwitchLayoutGroupContext = (0, import_react21.createContext)({});

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/utils/is-ref-object.mjs
...
function useVisualElement(Component4, visualState, props, createVisualElement, ProjectionNodeConstructor, isSVG2) {
  ...
  const wantsHandoff = (0, import_react22.useRef)(Boolean(optimisedAppearId) && typeof window !== "undefined" && !((_a = window.MotionHandoffIsComplete) == null ? void 0 : _a.call(window, optimisedAppearId)) && ((_b = window.MotionHasOptimisedAnimation) == null ? void 0 : _b.call(window, optimisedAppearId)));
  useIsomorphicLayoutEffect(() => {
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/render/components/create-proxy.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/motion/features/animation/index.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/motion/features/animation/exit.mjs
var id2 = 0;
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/motion/features/animations.mjs
var animations = {
  animation: {
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/events/event-info.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/events/add-pointer-event.mjs
function addPointerEvent(target, eventName, handler, options) {
  return addDomEvent(target, eventName, addPointerInfo(handler), options);
}

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/utils/get-context-window.mjs
var getContextWindow = ({ current }) => {
  return current ? current.ownerDocument.defaultView : null;
};

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/utils/distance.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/gestures/pan/PanSession.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/gestures/drag/utils/constraints.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/gestures/drag/VisualElementDragControls.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/gestures/drag/index.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/gestures/pan/index.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/motion/features/layout/MeasureLayout.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/motion/features/drag.mjs
var drag = {
  pan: {
    Feature: PanGesture
  },
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/gestures/hover.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/gestures/focus.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/gestures/press.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/motion/features/viewport/observers.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/motion/features/viewport/index.mjs
var thresholdNames = {
  some: 0,
  all: 1
};
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/motion/features/gestures.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/motion/features/layout.mjs
var layout = {
  layout: {
    ProjectionNode: HTMLProjectionNode,
    MeasureLayout
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/render/components/motion/feature-bundle.mjs
var featureBundle = {
  ...animations,
  ...gestureAnimations,
  ...drag,
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/render/components/motion/proxy.mjs
var motion = createMotionProxy(featureBundle, createDomVisualElement);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/components/LayoutGroup/index.mjs
var import_jsx_runtime6 = __toESM(require_jsx_runtime(), 1);
var import_react28 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/context/DeprecatedLayoutGroupContext.mjs
var import_react25 = __toESM(require_react(), 1);
var DeprecatedLayoutGroupContext = (0, import_react25.createContext)(null);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/utils/use-force-update.mjs
var import_react27 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/utils/use-is-mounted.mjs
var import_react26 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/components/LazyMotion/index.mjs
var import_jsx_runtime7 = __toESM(require_jsx_runtime(), 1);
var import_react29 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/components/MotionConfig/index.mjs
var import_jsx_runtime8 = __toESM(require_jsx_runtime(), 1);
var import_react30 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/render/components/m/proxy.mjs
var m2 = createMotionProxy();

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/utils/use-unmount-effect.mjs
var import_react31 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/render/dom/features-animation.mjs
var domAnimation = {
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/render/dom/features-max.mjs
var domMax = {
  ...domAnimation,
  ...drag,
  ...layout
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/render/dom/features-min.mjs
var domMin = {
  renderer: createDomVisualElement,
  ...animations
};

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/utils/use-motion-value-event.mjs
var import_react32 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/value/use-scroll.mjs
var import_react33 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/render/dom/scroll/offsets/presets.mjs
var ScrollOffset = {
  Enter: [
    [0, 1],
    [1, 1]
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/render/dom/scroll/utils/offset-to-range.mjs
var presets = [
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/value/use-motion-value.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/value/use-combine-values.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/value/use-follow-value.mjs
var import_react35 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/value/use-computed.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/value/use-transform.mjs
...
function useMapTransform(inputValue, inputRange, outputMap, options) {
  ...
  for (const key2 of keys) {
    output[key2] = useTransform(inputValue, inputRange, outputMap[key2], options);
  }
  return output;
}

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/utils/use-animation-frame.mjs
var import_react36 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/utils/reduced-motion/use-reduced-motion.mjs
var import_react37 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/utils/reduced-motion/use-reduced-motion-config.mjs
var import_react38 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/animation/hooks/use-animate.mjs
var import_react39 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/animation/utils/is-dom-keyframes.mjs
function isDOMKeyframes(keyframes2) {
  return typeof keyframes2 === "object" && !Array.isArray(keyframes2);
}

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/animation/animate/resolve-subjects.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/animation/sequence/utils/calc-repeat-duration.mjs
function calculateRepeatDuration(duration, repeat, _repeatDelay) {
  return duration * (repeat + 1);
}

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/animation/sequence/utils/calc-time.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/animation/sequence/utils/edit.mjs
...
function addKeyframes(sequence, keyframes2, easing, offset4, startTime, endTime) {
  ...
  for (let i = 0; i < keyframes2.length; i++) {
    sequence.push({
      value: keyframes2[i],
      at: mixNumber(startTime, endTime, offset4[i]),
      easing: getEasingForSegment(easing, i)
    });
  }
}

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/animation/sequence/utils/normalize-times.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/animation/sequence/utils/sort.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/animation/sequence/create.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/animation/utils/create-visual-element.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/animation/animate/subject.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/animation/animate/sequence.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/animation/animate/index.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/animation/animators/waapi/animate-elements.mjs
function animateElements(elementOrSelector, keyframes2, options, scope) {
  ...
  const animations2 = [];
  for (let i = 0; i < animationDefinitions.length; i++) {
    const { map, key: key2, options: animationOptions } = animationDefinitions[i];
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/animation/animators/waapi/animate-style.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/components/AnimatePresence/use-presence-data.mjs
var import_react40 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/events/use-dom-event.mjs
var import_react41 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/projection/use-reset-projection.mjs
var import_react42 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/utils/use-cycle.mjs
var import_react43 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/utils/use-in-view.mjs
var import_react44 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/utils/use-instant-transition.mjs
var import_react45 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/utils/use-page-in-view.mjs
var import_react46 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/animation/hooks/use-animated-state.mjs
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/components/AnimateSharedLayout.mjs
var import_jsx_runtime9 = __toESM(require_jsx_runtime(), 1);
var React4 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/value/use-inverted-scale.mjs
var import_react48 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/components/Reorder/Group.mjs
var import_jsx_runtime10 = __toESM(require_jsx_runtime(), 1);
var import_react50 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/context/ReorderContext.mjs
var import_react49 = __toESM(require_react(), 1);
var ReorderContext = (0, import_react49.createContext)(null);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/components/Reorder/utils/check-reorder.mjs
...
function ReorderGroupComponent({ children, as = "ul", axis = "y", onReorder, values, ...props }, externalRef) {
  ...
  return (0, import_jsx_runtime10.jsx)(Component4, { ...props, style: groupStyle, ref: setRef2, ignoreStrict: true, children: (0, import_jsx_runtime10.jsx)(ReorderContext.Provider, { value: context2, children }) });
}
...
// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/components/Reorder/Item.mjs
var import_jsx_runtime11 = __toESM(require_jsx_runtime(), 1);
var import_react51 = __toESM(require_react(), 1);

// ../node_modules/.pnpm/framer-motion@12.35.0_@emot_1ccda3c96aae2be1d5e6af0ec6074f46/node_modules/framer-motion/dist/es/components/Reorder/utils/auto-scroll.mjs
var threshold = 50;
var maxSpeed = 25;
...
function ReorderItemComponent({ children, style = {}, value, as = "li", onDrag, onDragEnd, layout: layout2 = true, ...props }, externalRef) {
  ...
  const { axis, registerItem, updateOrder, groupRef } = context2;
  return (0, import_jsx_runtime11.jsx)(Component4, { drag: axis, ...props, dragSnapToOrigin: true, style: { ...style, x: point.x, y: point.y, zIndex }, layout: layout2, onDrag: (event, gesturePoint) => {
    ...
    const offset4 = point[axis].get();
    updateOrder(value, offset4, velocity[axis]);
...
// ../node_modules/.pnpm/@sanity+ui@2.16.22_@emotion_23d1b0aa918918bf188b4335a184b3a2/node_modules/@sanity/ui/dist/_chunks-es/_visual-editing.mjs
...
var computePosition = async (reference, floating, config) => {
  ...
  for (let i = 0; i < middleware2.length; i++) {
    const currentMiddleware = middleware2[i];
...
function useArrayProp(val, defaultVal) {
  ...
  const [t1, setCache] = (0, import_react54.useState)(t0), [cachedVal, cachedHash] = t1, hash2 = JSON.stringify(val ?? defaultVal);
...
function useGlobalKeyDown(onKeyDown) {
  ...
  let t2;
  $2[4] === Symbol.for("react.memo_cache_sentinel") ? (t2 = [], $2[4] = t2) : t2 = $2[4], (0, import_react54.useEffect)(t1, t2);
}
...
function createGlobalScopedContext(key2, defaultValue) {
  ...
  return typeof document > "u" ? (0, import_react54.createContext)(defaultValue) : (globalScope[symbol] = globalScope[symbol] || (0, import_react54.createContext)(defaultValue), globalScope[symbol]);
}
...
function ThemeProvider(props) {
  ...
  let t2;
  $2[9] !== children || $2[10] !== theme ? (t2 = (0, import_jsx_runtime12.jsx)(Qe, { theme, children }), $2[9] = children, $2[10] = theme, $2[11] = t2) : t2 = $2[11];
  let t3;
...
function useTheme_v2() {
  const $2 = (0, import_react_compiler_runtime.c)(2), t0 = Ke();
  let t1;
...
function responsiveInputPaddingStyle(props) {
  ...
  return _responsive(media, _padding, (_2, i) => {
    const size22 = font.text.sizes[_fontSize[i]] || font.text.sizes[2], emSize = size22.lineHeight - size22.ascenderHeight - size22.descenderHeight, p2 = space[_padding[i]], s = space[_space[i]], styles = {
...
var SpanWithTextOverflow = ct.span.withConfig({
...
var StyledLabel = ct.div.withConfig({
...
var StyledAvatarCounter = ct.div.withConfig({
...
var StyledAvatarStack = ct.div.withConfig({
...
var AvatarStack = (0, import_react54.forwardRef)(function(props, ref) {
  ...
  const maxLengthProp = t0 === void 0 ? 4 : t0, sizeProp = t1 === void 0 ? 1 : t1, children = import_react54.Children.toArray(childrenProp).filter(import_react54.isValidElement), maxLength = Math.max(maxLengthProp, 0), size22 = useArrayProp(sizeProp), len = children.length, visibleCount = maxLength - 1, extraCount = len - visibleCount, visibleChildren = extraCount > 1 ? children.slice(extraCount, len) : children, T0 = StyledAvatarStack, t2 = "AvatarStack";
  let t3;
  ...
  let t5;
  $2[12] !== size22 ? (t5 = (child, childIndex) => (0, import_jsx_runtime12.jsx)("div", { children: (0, import_react54.cloneElement)(child, {
    size: size22
...
var StyledBox = ct.div.withConfig({
...
var StyledText = ct.div.withConfig({
...
var StyledBadge = ct(Box).withConfig({
...
var StyledFlex = ct(Box).withConfig({
...
`;
var StyledSpinner = ct(Text).withConfig({
...
var StyledButton = ct.button.withConfig({
  displayName: "StyledButton",
  componentId: "sc-aaekt4-0"
})(responsiveRadiusStyle, buttonBaseStyles, buttonColorStyles);
var LoadingBox = ct.div.withConfig({
...
var StyledCard = ct(Box).withConfig({
...
var StyledCheckbox = ct.div.withConfig({
  displayName: "StyledCheckbox",
  componentId: "sc-1l5mt2l-0"
})(checkboxBaseStyles);
var Input$5 = ct.input.withConfig({
  displayName: "Input",
...
var LazyRefractor = (0, import_react54.lazy)(() => import("./refractor-4GDYY6FF.js"));
var StyledCode = ct.pre.withConfig({
...
var Code = (0, import_react54.forwardRef)(function(props, ref) {
  ...
  let t4;
  $2[11] !== t2 || $2[12] !== t3 ? (t4 = (0, import_jsx_runtime12.jsx)(import_react54.Suspense, { fallback: t2, children: t3 }), $2[11] = t2, $2[12] = t3, $2[13] = t4) : t4 = $2[13];
  let t5;
...
var StyledContainer = ct(Box).withConfig({
...
var StyledGrid = ct(Box).withConfig({
...
var StyledHeading = ct.div.withConfig({
...
var StyledInline = ct(Box).withConfig({
...
var Inline = (0, import_react54.forwardRef)(function(props, ref) {
  ...
  let t0;
  $2[5] !== childrenProp ? (t0 = import_react54.Children.map(childrenProp, _temp$4), $2[5] = childrenProp, $2[6] = t0) : t0 = $2[6];
...
var StyledKBD = ct.kbd.withConfig({
...
var StyledArrow = ct.div.withConfig({
  ...
  `);
var StrokePath = ct.path.withConfig({
  displayName: "StrokePath",
  componentId: "sc-12vzy6c-1"
})`stroke:var(--card-shadow-outline-color);`;
var ShapePath = ct.path.withConfig({
...
var ElementQuery = (0, import_react54.forwardRef)(function(props, forwardedRef) {
  ...
  const media = _media ?? theme.media, [element, setElement] = (0, import_react54.useState)(null), width = ((_a = useElementSize(element)) == null ? void 0 : _a.border.width) ?? window.innerWidth;
  let t0;
...
function LayerProvider(props) {
  ...
  const [, setChildLayers] = (0, import_react54.useState)(t2), [size22, setSize] = (0, import_react54.useState)(0), isTopLayer2 = size22 === 0;
  let t3;
  ...
  let t4, t5;
  $2[6] !== level || $2[7] !== parentRegisterChild ? (t4 = () => parentRegisterChild == null ? void 0 : parentRegisterChild(level), t5 = [level, parentRegisterChild], $2[6] = level, $2[7] = parentRegisterChild, $2[8] = t4, $2[9] = t5) : (t4 = $2[8], t5 = $2[9]), (0, import_react54.useEffect)(t4, t5);
  let t6;
...
var StyledLayer = ct.div.withConfig({
...
function PortalProvider(props) {
  ...
  } = props, elements = useUnique(elementsProp), fallbackElement = (0, import_react54.useSyncExternalStore)(emptySubscribe, _temp$2, _temp2$1), t0 = boundaryElement || null, t1 = element || fallbackElement;
  let t2;
...
var StyledSrOnly = ct.div.withConfig({
...
var StyledVirtualList = ct.div.withConfig({
  displayName: "StyledVirtualList",
  componentId: "sc-dlqsj4-0"
})`position:relative;`;
var ItemWrapper = ct.div.withConfig({
...
var MotionCard$1 = ct(motion.create(Card)).withConfig({
...
var MotionFlex = ct(motion.create(Flex)).withConfig({
  displayName: "MotionFlex",
  componentId: "sc-ihg31s-1"
})`will-change:opacity;`;
var PopoverCard = (0, import_react54.memo)((0, import_react54.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime.c)(66);
...
var Popover = (0, import_react54.memo)((0, import_react54.forwardRef)(function(props, forwardedRef) {
  var _a, _b, _c, _d, _e2, _f;
  const {
    container: container2,
    layer
    ...
    updateRef,
    ...restProps
  } = props, animate2 = usePrefersReducedMotion() ? false : _animate, boundarySize = (_a = useElementSize(boundaryElement)) == null ? void 0 : _a.border, padding = useArrayProp(paddingProp), radius = useArrayProp(radiusProp), shadow = useArrayProp(shadowProp), widthArrayProp = useArrayProp(widthProp), zOffset = useArrayProp(zOffsetProp), ref = (0, import_react54.useRef)(null), arrowRef = (0, import_react54.useRef)(null), rootBoundary = "viewport";
  (0, import_react54.useImperativeHandle)(forwardedRef, () => ref.current);
  ...
  const maxWidth = calcMaxWidth({
    boundaryWidth,
    currentWidth: width
  }), maxWidthRef = (0, import_react54.useRef)(maxWidth);
  (0, import_react54.useEffect)(() => {
  ...
  const middleware2 = (0, import_react54.useMemo)(() => {
    const ret = [];
  ...
  }, [childProp, refs]), child = (0, import_react54.useMemo)(() => referenceElement ? childProp : childProp ? (0, import_react54.cloneElement)(childProp, {
    ref: setReference
...
var StyledRadio = ct.div.withConfig({
  displayName: "StyledRadio",
  componentId: "sc-ccrwkf-0"
})(radioBaseStyle);
var Input$4 = ct.input.withConfig({
  displayName: "Input",
...
var StyledSelect = ct.div.withConfig({
  displayName: "StyledSelect",
  componentId: "sc-5mxno7-0"
})(selectStyle.root);
var Input$3 = ct.select.withConfig({
  displayName: "Input",
  componentId: "sc-5mxno7-1"
})(selectStyle.input);
var IconBox = ct(Box).withConfig({
  displayName: "IconBox",
...
var StyledStack = ct(Box).withConfig({
...
var StyledSwitch = ct.span.withConfig({
  displayName: "StyledSwitch",
  componentId: "sc-dw1foe-0"
})(switchBaseStyles);
var Input$2 = ct.input.withConfig({
  displayName: "Input",
  componentId: "sc-dw1foe-1"
})(switchInputStyles);
var Representation = ct.span.withConfig({
  displayName: "Representation",
  componentId: "sc-dw1foe-2"
})(switchRepresentationStyles);
var Track = ct.span.withConfig({
  displayName: "Track",
  componentId: "sc-dw1foe-3"
})(switchTrackStyles);
var Thumb = ct.span.withConfig({
  displayName: "Thumb",
...
var TextInput = (0, import_react54.forwardRef)(function(props, forwardedRef) {
  ...
  const border2 = t0 === void 0 ? true : t0, disabled = t1 === void 0 ? false : t1, fontSizeProp = t2 === void 0 ? 2 : t2, paddingProp = t3 === void 0 ? 3 : t3, radiusProp = t4 === void 0 ? 2 : t4, spaceProp = t5 === void 0 ? 3 : t5, type = t6 === void 0 ? "text" : t6, ref = (0, import_react54.useRef)(null), rootTheme = useRootTheme(), fontSize2 = useArrayProp(fontSizeProp), padding = useArrayProp(paddingProp), radius = useArrayProp(radiusProp), space = useArrayProp(spaceProp), $hasClearButton = !!clearButton, $hasIcon = !!IconComponent, $hasIconRight = !!IconRightComponent, $hasSuffix = !!suffix, $hasPrefix = !!prefix2;
  let t7;
  $2[19] === Symbol.for("react.memo_cache_sentinel") ? (t7 = () => ref.current, $2[19] = t7) : t7 = $2[19], (0, import_react54.useImperativeHandle)(forwardedRef, t7), useCustomValidity(ref, customValidity);
...
var MotionCard = ct(motion.create(Card)).withConfig({
  displayName: "MotionCard",
  componentId: "sc-1xn138w-0"
})`will-change:transform;`;
var TooltipCard = (0, import_react54.memo)((0, import_react54.forwardRef)(function(props, ref) {
...
var StyledTooltip = ct(Layer).withConfig({
...
var Tooltip = (0, import_react54.forwardRef)(function(props, forwardedRef) {
  ...
  const boundaryElementContext = useBoundaryElement(), {
    ...
    delay: delay2,
    ...restProps
  } = props, animate2 = usePrefersReducedMotion() ? false : _animate, fallbackPlacements = useArrayProp(fallbackPlacementsProp), ref = (0, import_react54.useRef)(null), [referenceElement, setReferenceElement] = (0, import_react54.useState)(null), arrowRef = (0, import_react54.useRef)(null), rootBoundary = "viewport", [tooltipMaxWidth, setTooltipMaxWidth] = (0, import_react54.useState)(0);
  (0, import_react54.useImperativeHandle)(forwardedRef, () => ref.current);
  const portal = usePortal(), portalElement = typeof portalProp == "string" ? ((_a = portal.elements) == null ? void 0 : _a[portalProp]) || null : portal.element, middleware2 = (0, import_react54.useMemo)(() => {
    const ret = [];
  ...
  }, [isInsideGroup, openDelay, setIsGroupActive, setOpenTooltipId, tooltipId, closeDelay, setIsOpen]), handleBlur = (0, import_react54.useCallback)((e) => {
    var _a2, _b2;
    handleIsOpenChange(false), (_b2 = (_a2 = childProp == null ? void 0 : childProp.props) == null ? void 0 : _a2.onBlur) == null ? void 0 : _b2.call(_a2, e);
  }, [childProp == null ? void 0 : childProp.props, handleIsOpenChange]), handleClick = (0, import_react54.useCallback)((e_0) => {
    var _a2, _b2;
    handleIsOpenChange(false, true), (_b2 = childProp == null ? void 0 : (_a2 = childProp.props).onClick) == null ? void 0 : _b2.call(_a2, e_0);
  }, [childProp == null ? void 0 : childProp.props, handleIsOpenChange]), handleContextMenu = (0, import_react54.useCallback)((e_1) => {
    var _a2, _b2;
    handleIsOpenChange(false, true), (_b2 = childProp == null ? void 0 : (_a2 = childProp.props).onContextMenu) == null ? void 0 : _b2.call(_a2, e_1);
  }, [childProp == null ? void 0 : childProp.props, handleIsOpenChange]), handleFocus = (0, import_react54.useCallback)((e_2) => {
    var _a2, _b2;
  ...
  }, [childProp == null ? void 0 : childProp.props, handleIsOpenChange]), handleMouseEnter = (0, import_react54.useCallback)((e_3) => {
    var _a2, _b2;
  ...
  }, [childProp == null ? void 0 : childProp.props, handleIsOpenChange]), handleMouseLeave = (0, import_react54.useCallback)((e_4) => {
    var _a2, _b2;
  ...
  }, [disabled, handleIsOpenChange, showTooltip]), (0, import_react54.useEffect)(() => {
    !content2 && showTooltip && handleIsOpenChange(false);
  }, [content2, handleIsOpenChange, showTooltip]), (0, import_react54.useEffect)(() => {
  ...
  }, [handleIsOpenChange, showTooltip]), (0, import_react54.useLayoutEffect)(() => {
  ...
  const setArrow = (0, import_react54.useCallback)((arrowEl) => {
    arrowRef.current = arrowEl, update();
  }, [update]), setFloating = (0, import_react54.useCallback)((node2) => {
    ref.current = node2, refs.setFloating(node2);
  }, [refs]), child = (0, import_react54.useMemo)(() => childProp ? (0, import_react54.cloneElement)(childProp, {
    onBlur: handleBlur,
    onFocus: handleFocus,
  ...
  if ((0, import_react54.useImperativeHandle)(childProp ? getElementRef(childProp) : null, () => referenceElement, [referenceElement]), !child) return (0, import_jsx_runtime12.jsx)(import_jsx_runtime12.Fragment, {});
...
var Hotkeys = (0, import_react54.forwardRef)(function(props, ref) {
  ...
  if ($2[8] !== fontSize2 || $2[9] !== keys || $2[10] !== padding || $2[11] !== radius) {
    let t22;
    $2[13] !== fontSize2 || $2[14] !== padding || $2[15] !== radius ? (t22 = (key2, i) => (0, import_jsx_runtime12.jsx)(Key, { fontSize: fontSize2, padding, radius, children: key2 }, i), $2[13] = fontSize2, $2[14] = padding, $2[15] = radius, $2[16] = t22) : t22 = $2[16], t1 = keys.map(t22), $2[8] = fontSize2, $2[9] = keys, $2[10] = padding, $2[11] = radius, $2[12] = t1;
  } else
    t1 = $2[12];
  let t2;
...
function useMenuController(props) {
  const {
    ...
    shouldFocus,
    rootElementRef
  } = props, elementsRef = (0, import_react54.useRef)([]), [activeIndex, _setActiveIndex] = (0, import_react54.useState)(-1), activeIndexRef = (0, import_react54.useRef)(activeIndex), activeElement = (0, import_react54.useMemo)(() => elementsRef.current[activeIndex] || null, [activeIndex]), mounted = !!rootElementRef.current, setActiveIndex = (0, import_react54.useCallback)((nextActiveIndex) => {
    _setActiveIndex(nextActiveIndex), activeIndexRef.current = nextActiveIndex;
  }, []), mount = (0, import_react54.useCallback)((element, selected) => {
    if (!element) return () => {
    };
  ...
  }, [rootElementRef, setActiveIndex]), handleKeyDown = (0, import_react54.useCallback)((event) => {
    if (event.key === "Tab") {
  ...
  }, [onKeyDown, originElement, setActiveIndex]), handleItemMouseEnter = (0, import_react54.useCallback)((event_0) => {
    const element_0 = event_0.currentTarget, currentIndex_3 = elementsRef.current.indexOf(element_0);
    setActiveIndex(currentIndex_3);
  }, [setActiveIndex]), handleItemMouseLeave = (0, import_react54.useCallback)(() => {
    var _a;
...
var StyledMenu = ct(Box).withConfig({
...
var MenuDivider = ct.hr.withConfig({
...
var Selectable = ct(Box).withConfig({
...
function MenuGroup(props) {
  ...
  const as = t0 === void 0 ? "button" : t0, fontSize2 = t1 === void 0 ? 1 : t1, padding = t2 === void 0 ? 3 : t2, radius = t3 === void 0 ? 2 : t3, space = t4 === void 0 ? 3 : t4, tone = t5 === void 0 ? "default" : t5, menu = useMenu(), {
    ...
    registerElement
  } = menu, onItemMouseEnter = _onItemMouseEnter ?? menu.onMouseEnter, [rootElement, setRootElement] = (0, import_react54.useState)(null), [open, setOpen] = (0, import_react54.useState)(false), [shouldFocus, setShouldFocus] = (0, import_react54.useState)(null), active = !!activeElement && activeElement === rootElement, [withinMenu, setWithinMenu] = (0, import_react54.useState)(false);
  let t6;
...
var MenuItem = (0, import_react54.forwardRef)(function(props, forwardedRef) {
  ...
  } = menu, onItemMouseEnter = _onItemMouseEnter ?? menu.onMouseEnter, onItemMouseLeave = _onItemMouseLeave ?? menu.onMouseLeave, [rootElement, setRootElement] = (0, import_react54.useState)(null), active = !!activeElement && activeElement === rootElement, ref = (0, import_react54.useRef)(null);
  let t6;
  ...
  const setRef2 = t13, t14 = as !== "button" && pressed ? "" : void 0, t15 = active ? "" : void 0, t16 = disabled ? "" : void 0, t17 = useArrayProp(radius), t18 = useArrayProp(0), t19 = disabled ? "default" : tone, t20 = as === "button" ? "button" : void 0;
  let t21;
...
var CustomButton = ct(Button).withConfig({
...
var CustomInline = ct(Inline).withConfig({
...
// ../node_modules/.pnpm/@sanity+ui@2.16.22_@emotion_23d1b0aa918918bf188b4335a184b3a2/node_modules/@sanity/ui/dist/index.mjs
...
var ErrorBoundary = class extends import_react56.Component {
  constructor() {
    super(...arguments);
...
var StyledAutocomplete = ct.div.withConfig({
  displayName: "StyledAutocomplete",
  componentId: "sc-1igauft-0"
})`line-height:0;`;
var ListBox = ct(Box).withConfig({
  displayName: "ListBox",
...
var InnerAutocomplete = (0, import_react56.forwardRef)(function(props, forwardedRef) {
  const {
    border: border2 = true,
    customValidity,
    disabled,
    ...
    value: valueProp,
    ...restProps
  } = props, [state, dispatch] = (0, import_react56.useReducer)(autocompleteReducer, {
    ...
    query,
    value
  } = state, defaultRenderOption = (0, import_react56.useCallback)(({
    value: value_0
  }) => (0, import_jsx_runtime13.jsx)(Card, { "data-as": "button", padding: paddingProp, radius: 2, tone: "inherit", children: (0, import_jsx_runtime13.jsx)(Text, { size: fontSize2, textOverflow: "ellipsis", children: value_0 }) }), [fontSize2, paddingProp]), renderOption = typeof renderOptionProp == "function" ? renderOptionProp : defaultRenderOption, filterOption = typeof filterOptionProp == "function" ? filterOptionProp : DEFAULT_FILTER_OPTION, rootElementRef = (0, import_react56.useRef)(null), resultsPopoverElementRef = (0, import_react56.useRef)(null), inputElementRef = (0, import_react56.useRef)(null), listBoxElementRef = (0, import_react56.useRef)(null), listFocusedRef = (0, import_react56.useRef)(false), valueRef = (0, import_react56.useRef)(value), valuePropRef = (0, import_react56.useRef)(valueProp), popoverMouseWithinRef = (0, import_react56.useRef)(false);
  (0, import_react56.useImperativeHandle)(forwardedRef, () => inputElementRef.current);
  const listBoxId = `${id3}-listbox`, options = Array.isArray(optionsProp) ? optionsProp : EMPTY_ARRAY, padding = useArrayProp(paddingProp), currentOption = (0, import_react56.useMemo)(() => value !== null ? options.find((o2) => o2.value === value) : void 0, [options, value]), filteredOptions = (0, import_react56.useMemo)(() => options.filter((option) => query ? filterOption(query, option) : true), [filterOption, options, query]), filteredOptionsLen = filteredOptions.length, activeItemId = activeValue ? `${id3}-option-${activeValue}` : void 0, expanded = query !== null && loading || focused && query !== null, handleRootBlur = (0, import_react56.useCallback)((event) => {
    setTimeout(() => {
  ...
  }, [onBlur, onQueryChange, relatedElements]), handleRootFocus = (0, import_react56.useCallback)((event_0) => {
  ...
  }, []), handleOptionSelect = (0, import_react56.useCallback)((v2) => {
    var _a;
    dispatch({
      type: "value/change",
      value: v2
  ...
  }, [onChange, onSelect, onQueryChange]), handleRootKeyDown = (0, import_react56.useCallback)((event_1) => {
    var _a, _b;
  ...
  }, [activeValue, filteredOptions, filteredOptionsLen, onQueryChange]), handleInputChange = (0, import_react56.useCallback)((event_2) => {
    const nextQuery = event_2.currentTarget.value;
    dispatch({
      type: "input/change",
      query: nextQuery
    }), onQueryChange && onQueryChange(nextQuery);
  }, [onQueryChange]), dispatchOpen = (0, import_react56.useCallback)(() => {
    dispatch({
      type: "root/open",
      query: value ? renderValue(value, currentOption) : ""
    });
  }, [currentOption, renderValue, value]), handleInputFocus = (0, import_react56.useCallback)((event_3) => {
    focused || (dispatch({
      type: "input/focus"
    }), onFocus && onFocus(event_3), openOnFocus && dispatchOpen());
  }, [focused, onFocus, openOnFocus, dispatchOpen]), handlePopoverMouseEnter = (0, import_react56.useCallback)(() => {
    popoverMouseWithinRef.current = true;
  }, []), handlePopoverMouseLeave = (0, import_react56.useCallback)(() => {
    popoverMouseWithinRef.current = false;
  }, []), handleClearButtonClick = (0, import_react56.useCallback)(() => {
    var _a;
    dispatch({
      type: "root/clear"
    }), valueRef.current = "", onChange && onChange(""), onQueryChange && onQueryChange(null), (_a = inputElementRef.current) == null ? void 0 : _a.focus();
  }, [onChange, onQueryChange]), handleClearButtonFocus = (0, import_react56.useCallback)(() => {
    dispatch({
      type: "input/focus"
    });
  }, []);
  ...
  }, [valueProp]), (0, import_react56.useEffect)(() => {
    !focused && valueRef.current && dispatch({
      type: "root/setActiveValue",
      value: valueRef.current
    });
  }, [focused]), (0, import_react56.useEffect)(() => {
  ...
  const clearButton = (0, import_react56.useMemo)(() => {
    if (!loading && !disabled && value)
      return {
        "aria-label": "Clear",
        onFocus: handleClearButtonFocus
      };
  }, [disabled, handleClearButtonFocus, loading, value]), openButtonBoxPadding = (0, import_react56.useMemo)(() => padding.map((v_0) => v_0 === 0 ? 0 : v_0 === 1 || v_0 === 2 ? 1 : v_0 - 2), [padding]), openButtonPadding = (0, import_react56.useMemo)(() => padding.map((v_1) => Math.max(v_1 - 1, 0)), [padding]), openButtonProps = (0, import_react56.useMemo)(() => typeof openButton == "object" ? openButton : EMPTY_RECORD, [openButton]), handleOpenClick = (0, import_react56.useCallback)((event_4) => {
  ...
  }, [openButtonProps, dispatchOpen]), openButtonNode = (0, import_react56.useMemo)(() => !disabled && !readOnly && openButton ? (0, import_jsx_runtime13.jsx)(Box, { "aria-hidden": expanded, padding: openButtonBoxPadding, children: (0, import_jsx_runtime13.jsx)(Button, { "aria-label": "Open", disabled: expanded, fontSize: fontSize2, icon: ChevronDownIcon, mode: "bleed", padding: openButtonPadding, ...openButtonProps, onClick: handleOpenClick }) }) : void 0, [disabled, expanded, fontSize2, handleOpenClick, openButton, openButtonBoxPadding, openButtonPadding, openButtonProps, readOnly]), inputValue = (0, import_react56.useMemo)(() => query === null ? value !== null ? renderValue(value, currentOption) : "" : query, [currentOption, query, renderValue, value]), input = (0, import_jsx_runtime13.jsx)(TextInput, { ...restProps, "aria-activedescendant": activeItemId, "aria-autocomplete": "list", "aria-expanded": expanded, "aria-owns": listBoxId, autoCapitalize: "off", autoComplete: "off", autoCorrect: "off", border: border2, clearButton, customValidity, disabled, fontSize: fontSize2, icon, iconRight: loading && AnimatedSpinnerIcon, id: id3, inputMode: "search", onChange: handleInputChange, onClear: handleClearButtonClick, onFocus: handleInputFocus, padding, prefix: prefix2, radius, readOnly, ref: inputElementRef, role: "combobox", spellCheck: false, suffix: suffix || openButtonNode, value: inputValue }), handleListBoxKeyDown = (0, import_react56.useCallback)((event_5) => {
    var _a;
    event_5.key === "Tab" && listFocused && ((_a = inputElementRef.current) == null ? void 0 : _a.focus());
  }, [listFocused]), content2 = (0, import_react56.useMemo)(() => filteredOptions.length === 0 ? null : (0, import_jsx_runtime13.jsx)(ListBox, { "data-ui": "AutoComplete__results", onKeyDown: handleListBoxKeyDown, padding: 1, ...listBox, tabIndex: -1, children: (0, import_jsx_runtime13.jsx)(Stack, { as: "ul", "aria-multiselectable": false, "data-ui": "AutoComplete__resultsList", id: listBoxId, ref: listBoxElementRef, role: "listbox", space: 1, children: filteredOptions.map((option_0) => {
    const active = activeValue !== null ? option_0.value === activeValue : currentOption === option_0;
    return (0, import_jsx_runtime13.jsx)(AutocompleteOption, { id: `${id3}-option-${option_0.value}`, onSelect: handleOptionSelect, selected: active, value: option_0.value, children: (0, import_react56.cloneElement)(renderOption(option_0), {
      disabled: loading,
      selected: active,
      tabIndex: listFocused && active ? 0 : -1
    }) }, option_0.value);
  }) }) }), [activeValue, currentOption, filteredOptions, handleOptionSelect, handleListBoxKeyDown, id3, listBox, listBoxId, listFocused, loading, renderOption]), results = (0, import_react56.useMemo)(() => renderPopover ? renderPopover(
    // eslint-disable-next-line react-hooks/refs
    {
      content: content2,
      hidden: !expanded,
...
var StyledBreadcrumbs = ct.ol.withConfig({
...
var ExpandButton = ct(Button).withConfig({
  displayName: "ExpandButton",
  componentId: "sc-1es8h8q-1"
})`appearance:none;margin:-4px;`;
var Breadcrumbs = (0, import_react56.forwardRef)(function(props, ref) {
  ...
  const space = useArrayProp(t0 === void 0 ? 2 : t0), [open, setOpen] = (0, import_react56.useState)(false), expandElementRef = (0, import_react56.useRef)(null), popoverElementRef = (0, import_react56.useRef)(null);
  let t1;
  ...
  let t4;
  $2[9] !== children ? (t4 = import_react56.Children.toArray(children).filter(import_react56.isValidElement), $2[9] = children, $2[10] = t4) : t4 = $2[10];
  const rawItems = t4;
  let t5;
  bb0: {
  ...
  if ($2[33] !== items || $2[34] !== separator || $2[35] !== space) {
    let t72;
    $2[37] !== separator || $2[38] !== space ? (t72 = (item, itemIndex) => (0, import_jsx_runtime13.jsxs)(import_react56.Fragment, { children: [
...
function useDialog() {
  return (0, import_react56.useContext)(DialogContext);
}
...
var StyledDialog = ct(Layer).withConfig({
...
var DialogContainer = ct(Container).withConfig({
...
var DialogCardRoot = ct(Card).withConfig({
...
var DialogLayout = ct(Flex).withConfig({
  displayName: "DialogLayout",
  componentId: "sc-4n4xb3-3"
})`flex:1;min-height:0;width:100%;`;
var DialogHeader = ct(Box).withConfig({
  displayName: "DialogHeader",
  componentId: "sc-4n4xb3-4"
})`position:relative;z-index:2;`;
var DialogContent = ct(Box).withConfig({
  displayName: "DialogContent",
  componentId: "sc-4n4xb3-5"
})`position:relative;z-index:1;overflow:auto;outline:none;`;
var DialogFooter = ct(Box).withConfig({
  displayName: "DialogFooter",
  componentId: "sc-4n4xb3-6"
})`position:relative;z-index:3;`;
var DialogCard = (0, import_react56.forwardRef)(function(props, forwardedRef) {
  var _a;
  const $2 = (0, import_react_compiler_runtime2.c)(38), {
    ...
    shadow: shadowProp,
    width: widthProp
  } = props, portal = usePortal(), portalElement = portalProp ? ((_a = portal.elements) == null ? void 0 : _a[portalProp]) || null : portal.element, boundaryElement = useBoundaryElement().element, radius = useArrayProp(radiusProp), shadow = useArrayProp(shadowProp), width = useArrayProp(widthProp), ref = (0, import_react56.useRef)(null), contentRef = (0, import_react56.useRef)(null), layer = useLayer(), {
    isTopLayer: isTopLayer2
  } = layer, labelId = `${id3}_label`, showCloseButton = !!onClose && hideCloseButton === false, showHeader = !!header || showCloseButton;
  let t0;
  $2[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = () => ref.current, $2[0] = t0) : t0 = $2[0], (0, import_react56.useImperativeHandle)(forwardedRef, t0);
  let t1;
  $2[1] === Symbol.for("react.memo_cache_sentinel") ? (t1 = () => contentRef.current, $2[1] = t1) : t1 = $2[1], (0, import_react56.useImperativeHandle)(forwardedContentRef, t1);
  let t2, t3;
  $2[2] !== autoFocus ? (t2 = () => {
    autoFocus && ref.current && focusFirstDescendant(ref.current);
  }, t3 = [autoFocus, ref], $2[2] = autoFocus, $2[3] = t2, $2[4] = t3) : (t2 = $2[3], t3 = $2[4]), (0, import_react56.useEffect)(t2, t3);
  let t4;
...
var Dialog = (0, import_react56.forwardRef)(function(props, ref) {
  var _a;
  ...
  const handleFocus = t7, labelId = `${id3}_label`, rootClickTimeoutRef = (0, import_react56.useRef)(void 0);
  let t8;
...
var MenuButton = (0, import_react56.forwardRef)(function(props, forwardedRef) {
  ...
  } = props, disableRestoreFocusOnClose = t0 === void 0 ? false : t0, deprecated_portal = t1 === void 0 ? true : t1, [open, setOpen] = (0, import_react56.useState)(false), [shouldFocus, setShouldFocus] = (0, import_react56.useState)(null), [buttonElement, setButtonElement] = (0, import_react56.useState)(null);
  let t2;
  $2[0] === Symbol.for("react.memo_cache_sentinel") ? (t2 = [], $2[0] = t2) : t2 = $2[0];
  const [menuElements, setChildMenuElements] = (0, import_react56.useState)(t2), openRef = (0, import_react56.useRef)(open);
  let t3, t4;
  $2[1] !== onOpen || $2[2] !== open ? (t3 = () => {
    onOpen && open && !openRef.current && onOpen();
  }, t4 = [onOpen, open], $2[1] = onOpen, $2[2] = open, $2[3] = t3, $2[4] = t4) : (t3 = $2[3], t4 = $2[4]), (0, import_react56.useEffect)(t3, t4);
  let t5, t6;
  $2[5] !== onClose || $2[6] !== open ? (t5 = () => {
    onClose && !open && openRef.current && onClose();
  }, t6 = [onClose, open], $2[5] = onClose, $2[6] = open, $2[7] = t5, $2[8] = t6) : (t5 = $2[7], t6 = $2[8]), (0, import_react56.useEffect)(t5, t6);
  let t7, t8;
  $2[9] !== open ? (t7 = () => {
    openRef.current = open;
  }, t8 = [open], $2[9] = open, $2[10] = t7, $2[11] = t8) : (t7 = $2[10], t8 = $2[11]), (0, import_react56.useEffect)(t7, t8);
  let t9;
  ...
  let t17;
  $2[28] !== buttonElement || $2[29] !== handleBlur || $2[30] !== handleItemClick || $2[31] !== handleMenuClickOutside || $2[32] !== handleMenuEscape || $2[33] !== id3 || $2[34] !== menuProp || $2[35] !== shouldFocus ? (t17 = menuProp && (0, import_react56.cloneElement)(menuProp, {
    "aria-labelledby": id3,
  ...
  const menu = t17;
  let t18;
  $2[37] !== buttonProp || $2[38] !== handleMouseDown || $2[39] !== id3 || $2[40] !== open ? (t18 = buttonProp && (0, import_react56.cloneElement)(buttonProp, {
    "data-ui": "MenuButton",
    id: id3,
  ...
  const button = t18;
  let t19, t20;
  $2[42] !== buttonElement ? (t19 = () => buttonElement, t20 = [buttonElement], $2[42] = buttonElement, $2[43] = t19, $2[44] = t20) : (t19 = $2[43], t20 = $2[44]), (0, import_react56.useImperativeHandle)(forwardedRef, t19, t20);
  let t21;
...
`;
var StyledSkeleton$1 = ct(Box).withConfig({
  displayName: "StyledSkeleton",
  componentId: "sc-ebtpni-0"
})(responsiveRadiusStyle, skeletonStyle);
var Skeleton = (0, import_react56.forwardRef)(function(props, ref) {
  ...
  const animated = t0 === void 0 ? false : t0, [visible, setVisible] = (0, import_react56.useState)(!delay2);
  let t1, t2;
  $2[5] !== delay2 ? (t1 = () => {
    if (!delay2)
  ...
  }, t2 = [delay2], $2[5] = delay2, $2[6] = t1, $2[7] = t2) : (t1 = $2[6], t2 = $2[7]), (0, import_react56.useEffect)(t1, t2);
...
var StyledSkeleton = ct(Skeleton).withConfig({
  displayName: "StyledSkeleton",
...
var TextSkeleton = (0, import_react56.forwardRef)(function(props, ref) {
...
var LabelSkeleton = (0, import_react56.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime2.c)(7);
  let restProps, t0;
  $2[0] !== props ? ({
    size: t0,
...
var HeadingSkeleton = (0, import_react56.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime2.c)(7);
  let restProps, t0;
  $2[0] !== props ? ({
    size: t0,
...
var CodeSkeleton = (0, import_react56.forwardRef)(function(props, ref) {
  const $2 = (0, import_react_compiler_runtime2.c)(7);
  let restProps, t0;
  $2[0] !== props ? ({
    size: t0,
...
var TabPanel = (0, import_react56.forwardRef)(function(props, ref) {
...
var TextBox = ct(Flex).withConfig({
  displayName: "TextBox",
  componentId: "sc-1rr7rxo-0"
})`overflow-x:auto;`;
var StyledToast = ct(Card).withConfig({
...
var LoadingBar = ct.div.withConfig({
...
var LoadingBarMask = ct(Card).withConfig({
...
var LoadingBarProgress = ct(Card).withConfig({
...
function useMounted() {
  return (0, import_react56.useSyncExternalStore)(subscribe, _temp$12, _temp22);
}
function _temp22() {
  return false;
}
...
var StyledLayer2 = ct(Grid).withConfig({
  displayName: "StyledLayer",
...
function ToastProvider(props) {
  ...
  const [state, setState] = (0, import_react56.useState)(t1), mounted = useMounted();
  let t2;
  $2[1] === Symbol.for("react.memo_cache_sentinel") ? (t2 = {
    version: 0,
    push: (params) => {
      const id3 = params.id || generateToastId(), duration = params.duration || 5e3;
      return (0, import_react56.startTransition)(() => {
        setState((prevState) => {
          if (duration === 0.01)
            return prevState.filter((toast) => toast.id !== id3);
          const dismiss = () => (0, import_react56.startTransition)(() => setState((currentState) => currentState.filter((toast_0) => toast_0.id !== id3)));
...
function useToast() {
  const value = (0, import_react56.useContext)(ToastContext);
  if (!value)
...
var Tree = (0, import_react56.memo)((0, import_react56.forwardRef)(function(props, forwardedRef) {
  ...
  const space = t0 === void 0 ? 1 : t0, ref = (0, import_react56.useRef)(null), [focusedElement, setFocusedElement] = (0, import_react56.useState)(null), focusedElementRef = (0, import_react56.useRef)(focusedElement);
  let t1;
  $2[5] === Symbol.for("react.memo_cache_sentinel") ? (t1 = [], $2[5] = t1) : t1 = $2[5];
  const path = t1;
  let t2;
  $2[6] === Symbol.for("react.memo_cache_sentinel") ? (t2 = [], $2[6] = t2) : t2 = $2[6];
  const [itemElements, setItemElements] = (0, import_react56.useState)(t2);
  let t3;
  $2[7] === Symbol.for("react.memo_cache_sentinel") ? (t3 = {}, $2[7] = t3) : t3 = $2[7];
  const [state, setState] = (0, import_react56.useState)(t3), stateRef = (0, import_react56.useRef)(state);
  let t4;
  $2[8] === Symbol.for("react.memo_cache_sentinel") ? (t4 = () => ref.current, $2[8] = t4) : t4 = $2[8], (0, import_react56.useImperativeHandle)(forwardedRef, t4);
  let t5, t6;
  $2[9] !== focusedElement ? (t5 = () => {
    focusedElementRef.current = focusedElement;
  }, t6 = [focusedElement], $2[9] = focusedElement, $2[10] = t5, $2[11] = t6) : (t5 = $2[10], t6 = $2[11]), (0, import_react56.useEffect)(t5, t6);
  let t7, t8;
  $2[12] !== state ? (t7 = () => {
    stateRef.current = state;
  }, t8 = [state], $2[12] = state, $2[13] = t7, $2[14] = t8) : (t7 = $2[13], t8 = $2[14]), (0, import_react56.useEffect)(t7, t8);
  let t9;
  ...
  let t16;
  $2[26] !== children ? (t16 = [children], $2[26] = children, $2[27] = t16) : t16 = $2[27], (0, import_react56.useEffect)(t15, t16);
  let t17;
...
function useTree() {
  const tree = (0, import_react56.useContext)(TreeContext);
  if (!tree)
    throw new Error("Tree: missing context value");
  return tree;
}
var TreeGroup = (0, import_react56.memo)(function(props) {
  const $2 = (0, import_react_compiler_runtime2.c)(9);
  let children, restProps, t0;
  $2[0] !== props ? ({
    children,
...
var TreeItem = (0, import_react56.memo)(function(props) {
  const {
    ...
    weight,
    ...restProps
  } = props, rootRef = (0, import_react56.useRef)(null), treeitemRef = (0, import_react56.useRef)(null), tree = useTree(), {
    path,
    registerItem,
    setExpanded,
    setFocusedElement
  } = tree, _id = (0, import_react56.useId)(), id3 = idProp || _id, itemPath = (0, import_react56.useMemo)(() => path.concat([id3 || ""]), [id3, path]), itemKey = itemPath.join("/"), itemState = tree.state[itemKey], focused = tree.focusedElement === rootRef.current, expanded = (itemState == null ? void 0 : itemState.expanded) === void 0 ? expandedProp : (itemState == null ? void 0 : itemState.expanded) || false, tabIndex = tree.focusedElement && tree.focusedElement === rootRef.current ? 0 : -1, contextValue = (0, import_react56.useMemo)(() => ({
    ...tree,
    level: tree.level + 1,
    path: itemPath
  }), [itemPath, tree]), handleClick = (0, import_react56.useCallback)((event) => {
  ...
  }, [expanded, itemKey, onClick, setExpanded, setFocusedElement]), handleKeyDown = (0, import_react56.useCallback)((event_0) => {
    var _a;
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-RLS7T5ZW.js.map
